...
class PasswordResetView(APIView):
    """
      An Api View which provides a method to verifiy that a given pw-reset token 
      is valid before actually confirming the reset.
    """
...
def send_email(**kwargs):
    subject = kwargs.get("subject", "Tours and Itinerary management system")
